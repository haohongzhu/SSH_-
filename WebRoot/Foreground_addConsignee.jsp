...
<html>
  ...
  <body>
    ...
    <div id="addCon_main">
    	<div id="common_top">
    		<h5>您的位置：首页 > 我的地址 > 新增收货地址</h5>
    	</div>
    	
    	<div id="addCon_main_middle">
    		<s:form id="addCon_f" theme="simple" action="addConInfAction" method="post">
    			&nbsp;联系人&nbsp;&nbsp;
    			...
    			<br><br>
    			&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    			<s:radio list="%{#{'先生':'先生','女士':'女士'}}"  value="'先生'" cssClass="r1" name="consigneeInf.sex"/>
    			<br><br>
    			手机号码&nbsp;
    			...
    			<s:submit value="保 存 地 址" cssClass="change_b" />
    		</s:form>
    	</div>
    </div>
