 	...
 	<form action="updateAdminAction.action" method="post" >
		...
		<tr>
			...
			<input type="text" name="admin.adminRealName" id="adminRealName" 
				style="width:180px;align:left;height:30px;" value="<s:property value="admin.adminRealName" />" />
			</th>
			<th><s:property value="Errors.adminRealName[0]" /></th>
		</tr>
		<tr><td>&nbsp;</td></tr>
		<tr>
		...
		<select name="theRole" id="theRole">
				<option value=<s:property value="#session.roles.id" /> >
					<s:property value="#session.roles.positionName" />
				</option>
		</select>	
			</th>
		</tr>
		...
		<tr>
			...
			<th><s:property value="Errors.telephone[0]" /></th>
		</tr>
		<tr><td>&nbsp;</td></tr>
		<tr>
			...
			<th><s:property value="Errors.telephonep[0]" /></th>
		</tr>
		<tr><td>&nbsp;</td></tr>
		<tr>
