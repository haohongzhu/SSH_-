...
public class AdminQueryCusInfByNameAction extends ActionSupport{
	AdminDao ad;	
	List<Customer> customerWords; //持久化类集合
	...
	public AdminQueryCusInfByNameAction(){
	...
	public String execute()throws Exception{
		...
		//根据当前页查询要在该页上显示的数据
		customerWords=ad.queryByPageByName(realName,pageNo,pageSize);
		//设置当前页
		currentPage=pageNo;
